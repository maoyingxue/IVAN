...
PATH_TO_CKPT = '/home/iris/IVAN/interface/frozen_inference_graph.pb'
PATH_TO_LABELS = '/home/iris/IVAN/interface/label_map.pbtxt'
NUM_CLASSES = 6
print(0)
...
def detect(img):
    ...
    print("Time used:",(time.time()-ticks)*1000)
    return result      
